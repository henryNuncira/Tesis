...
{path: 'contlistas', component:ContlistasComponent},
{path: 'contAdmin', component:ContlistasAdminComponent},
{path: 'acerca', component:AboutComponent},
{path: 'blog', component:BlogComponent},
{path: 'productos', component:ProductosComponent},
{path: 'contacto', component:ContactoComponent},
  { path: 'listadoCategorias', loadChildren: () => import('./vistas/categorias/listado-categorias/listado-categorias.module').then(m => m.ListadoCategoriasModule) },
  ...
  { path: 'listadoClientes', loadChildren: () => import('./vistas/clientes/listado-clientes/listado-clientes.module').then(m => m.ListadoClientesModule) },
  ...
  { path: 'listadoProductos', loadChildren: () => import('./vistas/productos/listado-productos/listado-productos.module').then(m => m.ListadoProductosModule) },
  ...
  { path: 'listadoProveedores', loadChildren: () => import('./vistas/proveedores/listado-proveedores/listado-proveedores.module').then(m => m.ListadoProveedoresModule) },
  ...
  { path: 'listadoVendedores', loadChildren: () => import('./vistas/vendedores/listado-vendedores/listado-vendedores.module').then(m => m.ListadoVendedoresModule) },
  ...
  { path: 'listadoVenta', loadChildren: () => import('./vistas/venta/listado-venta/listado-venta.module').then(m => m.ListadoVentaModule) },
